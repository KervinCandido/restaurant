...
@Component
public class MenuItemDeletedPublisher implements PublisherGateway<MenuItem> {
    ...
    public CompletableFuture<Void> publish(MenuItem menuItem) {
        var eventDTO = new EventDTO<>(MENU_ITEM_DELETE_EVENT_TYPE, new MenuItemDTO(menuItem));
